...
var todays_count_missing_items : int = 0 
var todays_count_sent_items : int = 0 
var todays_count_incorrect_items : int = 0 

func reset_todays_metrics():
	todays_count_missing_items = 0 
	todays_count_sent_items = 0 
	todays_count_incorrect_items = 0 
